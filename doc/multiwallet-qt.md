...
In order to support loading of multiple wallets in ghr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ghr.cpp.
...
Changes to ghr.cpp
----------------------
ghr.cpp is the entry point into ghr-qt, and as such, will require some minor modifications to provide hooks for

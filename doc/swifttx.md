...
This mechanism has been integrated into Bitcore-Node-GHR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GHR-Project/insight-api-ghr#web-socket-api](https://github.com/GHR-Project/insight-api-ghr#web-socket-api) 
* API: [https://github.com/GHR-Project/insight-api-ghr#swifttx-transactions](https://github.com/GHR-Project/insight-api-ghr#swifttx-transactions) 
...
By default, the GHR Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GHR Core daemon:

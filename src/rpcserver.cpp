...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GHR features */
        {"ghr", "masternode", &masternode, true, true, false},
        {"ghr", "listmasternodes", &listmasternodes, true, true, false},
        {"ghr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ghr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ghr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ghr", "masternodedebug", &masternodedebug, true, true, false},
        {"ghr", "startmasternode", &startmasternode, true, true, false},
        {"ghr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ghr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ghr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ghr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ghr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ghr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ghr", "mnbudget", &mnbudget, true, true, false},
        {"ghr", "preparebudget", &preparebudget, true, true, false},
        {"ghr", "submitbudget", &submitbudget, true, true, false},
        {"ghr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ghr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ghr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ghr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ghr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ghr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ghr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ghr", "checkbudgets", &checkbudgets, true, true, false},
        {"ghr", "mnsync", &mnsync, true, true, false},
        {"ghr", "spork", &spork, true, true, false},
        {"ghr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ghr", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ghrd, or the -server option to ghr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ghr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13816/\n";
}
